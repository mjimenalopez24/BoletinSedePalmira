...
Este séptimo Boletín de Sede presenta los indicadores básicos de la Sede del último periodo registrado, y su evolución histórica, información detallada de [aspirantes, admitidos](#Aspirantes) y [estudiantes](PobEst), [docencia](Doc), [administrativos](Admini),..., que de acuerdo al interés particular de cada lector podrá conocer en detalle y dar el uso e interpretación que considere.
